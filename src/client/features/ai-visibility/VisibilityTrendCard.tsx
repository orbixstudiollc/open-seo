  ...
  return (
    <section className="ai-visibility-card overflow-hidden">
      ...
      {overview.comparison.status !== "available" ? (
        <div className="flex items-start gap-2 border-t border-[var(--visibility-hairline)] bg-[var(--visibility-canvas-soft)] px-5 py-3 text-[13px] text-[var(--visibility-body)]">
