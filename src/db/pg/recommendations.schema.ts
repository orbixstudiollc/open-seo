...
export const recommendationAuditIssueEvidence = pgTable(
...
export const recommendationCitationEvidence = pgTable(
...
export const recommendationScoreFactors = pgTable(
