...
const dataEnv = {
  ...
  AI_BASE_URL: optionalVar("AI_BASE_URL"),
  AI_API_KEY: optionalSecret("AI_API_KEY"),
  AI_MODEL: optionalVar("AI_MODEL"),
  AI_SCORING_INPUT_USD_PER_MILLION: optionalVar(
    "AI_SCORING_INPUT_USD_PER_MILLION",
  ),
  AI_SCORING_OUTPUT_USD_PER_MILLION: optionalVar(
    "AI_SCORING_OUTPUT_USD_PER_MILLION",
  ),
  ...
  LOOPS_TRANSACTIONAL_REPORT_DIGEST_ID: optionalVar(
    "LOOPS_TRANSACTIONAL_REPORT_DIGEST_ID",
  ),
  REPORT_PUBLIC_ORIGIN: optionalVar("REPORT_PUBLIC_ORIGIN"),
  REPORT_PUBLIC_SHARE_MODE: optionalVar("REPORT_PUBLIC_SHARE_MODE"),
